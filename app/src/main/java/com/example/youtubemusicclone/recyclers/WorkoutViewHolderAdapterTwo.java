...
public class WorkoutViewHolderAdapterTwo extends RecyclerView.Adapter<WorkoutViewHolderAdapterTwo.ItemViewHolder> {

    List<WorkoutModel> workoutModelList;

    public WorkoutViewHolderAdapterTwo(List<WorkoutModel> workoutModelList) {
        this.workoutModelList = workoutModelList;
    }

    @NonNull
    @Override
    public  WorkoutViewHolderAdapterTwo.ItemViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_workout,parent,false);
        return new WorkoutViewHolderAdapterTwo.ItemViewHolder(view);
    }
