...
public class WorkoutViewHolderAdapterfour extends RecyclerView.Adapter<WorkoutViewHolderAdapterfour.ItemViewHolder> {

    List<WorkoutModel> workoutModelList;

    public WorkoutViewHolderAdapterfour(List<WorkoutModel> workoutModelList) {
        this.workoutModelList = workoutModelList;
    }

    @NonNull
    @Override
    public WorkoutViewHolderAdapterfour.ItemViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_workout,parent,false);
        return new WorkoutViewHolderAdapterfour.ItemViewHolder(view);
    }
